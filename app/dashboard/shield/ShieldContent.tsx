...
interface InnerShieldContentProps {
  inputValue: string;
  network: Network;
  pair: EnrichedPair;
  pairs: EnrichedPair[];
...
function InnerShieldContent({
  ...
  const maxBalance = underlyingBalance;
  const maxDecimals = pair.tokenDecimals;
  ...
  const isShielding = wrap.state !== "idle";
  const isBusy = isShielding;
  ...
  const activeError = wrap.errorMessage;
          ...
          <div className="bg-white border border-gray-200 rounded-xl  shadow-sm">
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <div ref={dropdownRef} className="relative">
                  <div className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 cursor-pointer hover:border-gray-300" onClick={() => setDropdownOpen(!dropdownOpen)}>
                    ...
                    <div className="flex items-center gap-2 ml-2">
                      ...
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={`w-4 h-4 text-gray-400 transition-transform ${dropdownOpen ? "rotate-180" : ""}`}>
                        ...
                        >
                          <div className="w-4 h-4 rounded-full bg-[#d0ede2] flex items-center justify-center shrink-0 overflow-hidden">
                            {getTokenIconSrc(p.wrapperSymbol) ? (
                              ...
                              p.tokenSymbol.slice(0, 2).toUpperCase()
                            )}
                          </div>
                ...
                {authenticated && parsedAmount > underlyingBalance && (
              ...
              <div>
                ...
                <div className="flex items-center justify-between  border border-gray-200 rounded-lg px-4 py-3">
                  <span className="text-xl font-light text-gray-700">
                    {expectedOut !== null ? formatTokenUnits(expectedOut, pair.wrapperDecimals, 4) : "0.00"}
                  </span>
                  ...
                  <div>
                    ...
                    <div className="text-sm font-semibold text-gray-900 mt-0.5">
                      {balances?.confidentialBalance !== undefined
                        ? `${formatTokenUnits(balances.confidentialBalance, pair.wrapperDecimals, 4)} ${pair.wrapperSymbol}`
                        : "••••••"}
                    </div>
                  </div>
                  <button
              ...
              <button
                ...
                disabled={isBusy && wrap.state !== "error"}

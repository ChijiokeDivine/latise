...
export default function FaucetContent() {
    ...
    return (
      <div className="p-4 md:p-6 flex items-center justify-center h-full">
        <div className="text-center max-w-sm">
          <Image
            src="/faucet-removebg-preview.png"
            alt="Faucet"
            width={120}
            height={120}
  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      ...
      <div className="mb-6 bg-gray-50 border border-gray-200 rounded-2xl p-5 hidden md:block">
...
function FaucetCard({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5 mt-3 md:mt-0 flex flex-col gap-4 hover:border-[#a3d9c4] transition">
      <div className="flex items-center gap-3 mb-5 md:mb-0">
        <div className="w-10 h-10 rounded-full bg-[#d0ede2] flex items-center justify-center text-[#156640] font-bold text-sm shrink-0 overflow-hidden">
          {getTokenIconSrc(token.symbol) ? (
            <Image
              src={getTokenIconSrc(token.symbol)!}
      ...
      <button
        ...
        className={`w-full py-2.5 rounded-3xl text-sm font-semibold cursor-pointer transition ${
          isDone
            ...
            : "bg-[#171717]/90 hover:bg-[#171717] text-white"
        }`}
      >
